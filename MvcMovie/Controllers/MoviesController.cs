...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string movieGenre, string searchString, string sortOrder)
        {
            ...
            switch(sortOrder)
            {
                ...
                case "date_desc":
                    ...
                    break;
                default:
                    movies = movies.OrderBy(m => m.ReleaseDate.Date);
                    break;
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price,Rating,Image")] Movie movie)
        {
            ...
            GenreDropDown(movie.Genre);
            return View(movie);
        }

        private void GenreDropDown(object selectedGenre = null)
        {
            var genresQuery = from g in _context.Movie
                              orderby g.Genre
                              select g.Genre;

            ViewBag.Genre = new SelectList(genresQuery.Distinct().ToList(), selectedGenre);
        }
